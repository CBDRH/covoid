...
This model is recommended for modelling COVID-19, it is based on Churches and Jorm (2020) and Moss et al (2020).
...
This model is recommended for modelling COVID-19, it is a (partial) reproduction Moss et al (2020).
...
Moss R., Wood J., Brown D., Shearer F., Black, A.J., Cheng A.C., McCaw J.M., McVernon J. (2020). Modelling the impact of COVID-19 in Australia to inform transmission reducing measures and health system preparedness. The Peter Doherty Institute for Infection and Immunity, VIC, Australia. https://www.doherty.edu.au/uploads/content_doc/McVernon_Modelling_COVID-19_07Apr1_with_appendix.pdf
