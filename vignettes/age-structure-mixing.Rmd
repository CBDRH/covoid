...
We can add in time varying interventions using `create_intervention`. The below example reduces all 
contact by 20%. Simulates physical distancing.

```{r, fig.width=7}
phys_dist = create_intervention(start = 10,stop = 150,c_reduce = 0.8,start_delay = 5,stop_delay = 5)
param <- sir_c_param(R0 = 2.5,gamma = 0.1,cm=cm_oz,dist=p_age_oz,intervention = phys_dist)
state0 <- sir_c_state0(S0 = S0,I0 = I0,R0 = R0)
res <- simulate_c_sir(t = 200,state_t0 = state0,param = param)
...
int = list(sch=create_intervention(start = 10,stop = 150,c_reduce = 0.2,start_delay = 5,stop_delay = 5),
           all=create_intervention(start = 10,stop = 150,c_reduce = 0.8,start_delay = 5,stop_delay = 5))
param <- sir_c_param(R0 = 2.5,gamma = 0.1,cm=cm,dist=p_age_oz,intervention = int)
state0 <- sir_c_state0(S0 = S0,I0 = I0,R0 = R0)
res <- simulate_c_sir(t = 200,state_t0 = state0,param = param)
