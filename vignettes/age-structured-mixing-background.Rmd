...
```{r,fig.cap="Contact matrices for school, work, home and other locations (source: Prem et al ()). Note the differing scales.",fig.width=6,fig.height=5}
...
```{r,fig.cap="hello",fig.height=2,fig.width=6}
...
In the current model R0 is also a threshold parameter
