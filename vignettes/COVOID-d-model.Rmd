...
![Moss _et al_. model presented as an interactive GUI]("vignettes/model-gui.png")
This interface will be embedded as part of a downloadable _R_ package, and also made available as a webpage.  Users will be able to generate and download customisable dynamic reports based on the scenarios they explore, that summarise the results as well as document the underlying assumptions and model parameter settings.
