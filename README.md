...
For information on installing COVOID and a basic illustrating of the programming API keep reading, or visit the [COVOID website](www.cbdrh.github.io/covoid) for more information and to use the interactive Shiny platform..
...
devtools::install_github("cbdrh/covoid")
```
## Example
...
```
<img src="man/figures/README-example-1.png" width="100%" height="60%" />
...
<img src="man/figures/README-example-2.png" width="100%" height="60%" />
...
<img src="man/figures/README-example-4.png" width="100%" height="60%" />

For more information see `vignette()` or visit the [COVOID website](www.cbdrh.github.io/covoid)
