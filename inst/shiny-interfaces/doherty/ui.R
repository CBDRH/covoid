...
sidebar <- dashboardSidebar(width = 450,
            ...
            splitLayout(cellWidths = c('33%', '33%', '33%'),
                prettyCheckbox(inputId = "r0t", label = "Time varying", icon = icon("chart-line"), value=FALSE),
                actionLink(inputId = "sigmat", label = "Time varying", icon = icon("chart-line"))
            ),
            splitLayout(cellWidths = c('33%', '33%', '33%'),
                conditionalPanel("input.r0t == 1", sparkline(c(1:10)))
            ),
            hr(),
            splitLayout(cellWidths = c('33%', '33%', '33%'),
